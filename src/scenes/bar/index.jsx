...
import dayjs from "dayjs"; // pastikan sudah install: npm install dayjs

const Bar = () => {
  const [dailyData, setDailyData] = useState([]);
  const [page, setPage] = useState(0); // Menyimpan halaman aktif
        ...
        <Box ml={4} flex={1} minWidth="400px">
          ...
          <TableContainer component={Paper}>
            ...
            <TablePagination
              ...
              component="div"
              count={dailyData.length} // Jumlah total data
